...
let routes = [
  ...
  { name: 'agb', path: '/agb', component: Static, props: {page: 'agb', title: 'AGB'}, meta: {title: 'Legal Notice', description: 'Legal Notice - example of description usage'} },
  { name: 'datenschutz', path: '/datenschutz', component: Static, props: {page: 'datenschutz', title: 'Datenschutz'} },
  { name: 'diamanten', path: '/diamanten', component: Static, props: {page: 'dimanten', title: 'Diamanten'} },
  { name: 'freundschaftsringe', path: '/freundschaftsringe', component: Static, props: {page: 'freundschaftsringe', title: 'Freundschaftsringe'} },
  { name: 'individuelle-Gravur', path: '/individuelle-Gravur', component: Static, props: {page: 'Individuelle Gravur', title: 'Individuelle Gravur'} },
  { name: 'hilfe', path: '/hilfe', component: Static, props: {page: 'hilfe', title: 'Hilfe'} },
  { name: 'impressum', path: '/impressum', component: Static, props: {page: 'impressum', title: 'Impressum'} },
  { name: 'legierungen', path: '/legierungen', component: Static, props: {page: 'legierungen', title: 'Legierungen'} },
  { name: 'lieferung', path: '/lieferung', component: Static, props: {page: 'lieferung', title: 'Lieferung'} },
  { name: 'partnerringe', path: '/partnerringe', component: Static, props: {page: 'partnerringe', title: 'Partnerringe'} },
  { name: 'ringgroesse', path: '/ringgroesse', component: Static, props: {page: 'ringgroesse', title: 'Ringgroesse'} },
  { name: 'ringmass-senden', path: '/ringmass-senden', component: Static, props: {page: 'ringmass-senden', title: 'Ringmaß'} },
  { name: 'schweiz', path: '/schweiz', component: Static, props: {page: 'schweiz', title: 'Hinweise Schweiz'} },
